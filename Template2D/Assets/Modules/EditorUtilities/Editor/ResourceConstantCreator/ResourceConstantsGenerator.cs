...
namespace Starvoxel.EditorUtilities
{
    ...
    public partial class ResourceConstantsGenerator : ResourceConstantsGeneratorBase
    {
        /// <summary>
...
namespace ");
		...
		foreach(KeyValuePair<string, string[]> pair in m_ConstantsDictionary)
        {
            ...
            this.Write("\t\t#region ");
            this.Write(this.ToStringHelper.ToStringWithCulture(regionName));
            this.Write("\r\n");
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(constantName));
            this.Write(" = @\"");
            this.Write(this.ToStringHelper.ToStringWithCulture(pair.Value[fileIndex].Substring(0, extensionStartIndex)));
            this.Write("\";\r\n");
...
private global::System.Collections.Generic.Dictionary<System.String, System.String[]> _m_ConstantsDictionaryField;

/// <summary>
/// Access the m_ConstantsDictionary parameter of the template.
/// </summary>
private global::System.Collections.Generic.Dictionary<System.String, System.String[]> m_ConstantsDictionary
{
    get
    {
        return this._m_ConstantsDictionaryField;
    }
}
...
bool m_ConstantsDictionaryValueAcquired = false;
if (this.Session.ContainsKey("m_ConstantsDictionary"))
{
    this._m_ConstantsDictionaryField = ((global::System.Collections.Generic.Dictionary<System.String, System.String[]>)(this.Session["m_ConstantsDictionary"]));
    m_ConstantsDictionaryValueAcquired = true;
}
if ((m_ConstantsDictionaryValueAcquired == false))
{
    object data = global::System.Runtime.Remoting.Messaging.CallContext.LogicalGetData("m_ConstantsDictionary");
    if ((data != null))
    {
        this._m_ConstantsDictionaryField = ((global::System.Collections.Generic.Dictionary<System.String, System.String[]>)(data));
    }
}
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "12.0.0.0")]
    public class ResourceConstantsGeneratorBase
    {
        #region Fields
