...
public class NewScriptWindow : EditorWindow
{
    ...
    private const string TEMPLATE_PATH = "Modules/CreateScriptDialog/OtherResources/ScriptTemplates";
    private const string HEADER_PATH = "Modules/CreateScriptDialog/OtherResources/HeaderTemplates";
    ...
    {
        return Path.Combine(Application.dataPath, TEMPLATE_PATH);
    }

    private string GetAbsoluteHeaderPath()
    {
        return Path.Combine(Application.dataPath, HEADER_PATH);
    }
